...
class Auth extends CI_Controller
{
	...
	public function activate($id, $code = FALSE)
	{
		...
		if ($activation)
		{
			...
			$this->session->set_flashdata('message', $this->ion_auth->messages());
			redirect("dashboard/setting/user", 'refresh');
		}
		else
		{
	...
	public function deactivate($id = NULL)
	{
		...
		{
			// redirect them to the auth page
			$this->session->set_flashdata('message', "The confirmation field is required.");
			redirect("dashboard/setting/user", 'refresh');
	...
	public function create_user(){
		...
		{
			$this->form_validation->set_rules('email', "Email address already used", 'trim|required|valid_email|is_unique[' . $tables['users'] . '.email]');
		}
		...
		if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $username, $password, $email, $additional_data))
		{
	...
	public function delete($id) {
		...
		// Set message
		$this->session->set_flashdata('delete_user', 'Delete success');
